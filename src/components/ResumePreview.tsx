...
export default function ResumePreview({resumeData, contentRef, className}: ResumePreviewProps) {
    ...
    return (
        <div className={cn("bg-white text-black h-fit w-full aspect-[210/297]", 
        className,
        )}
        ref = {containerRef}
        >
    ...
    <div className="space-y-3">
        ...
        {workExperiencesNotEmpty.map((exp, index) => (
            <div key={index} className="break-inside-avoid space-y-1">
                ...
                <p className="text-sx font-semibold">{exp.company}</p>
                <div className="whitespace-pre-line text-sx">
                    {exp.description}
                </div>
            </div>
        ))}
    ...
    <div className="space-y-3">
        ...
        {educationNotEmpty.map((edu, index) => (
            <div key={index} className="break-inside-avoid space-y-1">
                ...
                <p className="text-sx font-semibold">{edu.school}</p>
            </div>
        ))}
    </div>
    </>
